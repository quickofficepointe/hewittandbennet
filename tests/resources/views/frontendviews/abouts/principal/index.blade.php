...
<div class="container mx-auto mt-8 px-4">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="message-image-container flex flex-col items-center p-6 bg-gray-100 rounded-lg shadow-lg">
        ...
        <div class="message-container p-6 bg-gray-100 rounded-lg shadow-lg">
