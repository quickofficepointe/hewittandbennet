...
<div class="container mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6" x-data="{ openPaymentModal: false }" x-cloak>
            <h2 class="text-2xl font-bold text-gray-800">Payment Receipts</h2>
            <!-- Trigger Button -->
            <button @click="openPaymentModal = true" class="bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 rounded-lg shadow transition flex items-center mb-4">
                <i class="fas fa-plus mr-2"></i> Create Receipt
            </button>

            <!-- Modal Backdrop -->
            <div x-show="openPaymentModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-50" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
            </div>

            <!-- Modal Content -->
            <div x-show="openPaymentModal" class="fixed inset-0 z-50 overflow-y-auto" @click.away="openPaymentModal = false">
                    ...
                    <div class="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div class="bg-blue-700 px-4 py-3">
                            <div class="flex items-center justify-between">
                                <h3 class="text-lg font-medium text-white">Create Payment Receipt</h3>
                                <button @click="openPaymentModal = false" class="text-white hover:text-blue-200">
                                    <i class="fas fa-times"></i>
                                </button>
                            </div>
                        </div>
                        <div class="p-6">
                            <form action="{{ route('payment-receipts.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="Name" class="w-full rounded-md border-gray-300 shadow-sm p-2 border" required>
                                </div>
                                <div class="mb-4">
                                    <label for="student_no" class="block text-sm font-medium text-gray-700 mb-1">Student Number</label>
                                    <div class="flex space-x-2">
                                        <input type="text" id="student_no" name="student_no" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="contact" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required>
                                </div>

                                <div class="mb-4">
                                    <label for="Amount" class="block text-sm font-medium text-gray-700 mb-1">Amount</label>
                                    <input type="number" name="Amount" step="0.01" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required>
                                </div>

                                <div class="mb-4">
                                    <label for="paymentfor" class="block text-sm font-medium text-gray-700 mb-1">Payment For</label>
                                    <input type="text" name="paymentfor" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required list="paymentOptions" placeholder="Enter or select an option">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="modeofpayment" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required>
                                ...
                                <div class="mb-2 text-xs text-gray-500 italic">Receipt No will be auto-generated.</div>
                                <div class="mt-6 flex justify-end space-x-3">
                                    <button type="button" @click="openPaymentModal = false" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                        Cancel
                                    </button>
                                    <button type="submit" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-700 hover:bg-blue-800">
                                        Add Receipt
                                    </button>
                                </div>
                            </form>
...
<div x-data="{ openModal: false }" x-cloak>
    <!-- Modal Backdrop -->
    <div x-show="openModal" class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity z-50" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
    </div>

    <!-- Modal Content -->
    <div x-show="openModal" class="fixed inset-0 z-50 overflow-y-auto" @click.away="openModal = false">
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div class="bg-blue-700 px-4 py-3">
                    <div class="flex items-center justify-between">
                ...
                <div class="p-6">
                    <form action="{{ route('payment-receipts.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-2">
                                <input type="text" id="student_no" name="student_no" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required>
                                <button type="button" id="searchStudent" class="bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 rounded-lg shadow transition">
                                    Search
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="Name" class="block text-sm font-medium text-gray-700 mb-1">Name</label>
                            <input type="text" name="Name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" required>
                        </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <button type="button" @click="openModal = false" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Cancel
                            </button>
