    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden p-6">
        ...
        <form action="{{ route('hewitt_banners.update', $banner->id) }}" method="post" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex justify-between">
                <a href="{{ route('hewitt_banners.index') }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-700 hover:bg-yellow-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                    Manage Banner
                </a>
