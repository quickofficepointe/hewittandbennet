...
Route::get('/', function () {
    ...
    // social media videos
    $tiktokVideos = tiktokvid::latest()->take(3)->get(); // Fetch latest 3 TikTok videos
    // Fetch all testimonials
    $testimonials = Testimonial::latest()->take(3)->get(); // Fetch latest 3

    // reviews
    $reviews = reviews::all(); // all
...
Route::put('/studentregistration/{courseapplication}', [App\Http\Controllers\CourseapplicationController::class, 'update'])->name('studentregistration.update');
Route::delete('/studentregistration/{courseapplication}', [App\Http\Controllers\CourseapplicationController::class, 'destroy'])->name('studentregistration.destroy');
...
// reviews
Route::post('/review', [App\Http\Controllers\ReviewsController::class, 'store'])->name('review.store');
Route::get('/index/review', [App\Http\Controllers\ReviewsController::class, 'index'])->name('reviews.index');
Route::get('/reviews/{id}/edit', [App\Http\Controllers\ReviewsController::class, 'edit'])->name('reviews.edit');
Route::put('/reviews/{id}', [App\Http\Controllers\ReviewsController::class, 'update'])->name('reviews.update');
Route::delete('/reviews/{id}', [App\Http\Controllers\ReviewsController::class, 'destroy'])->name('reviews.destroy');
Route::post('/reviews/{id}/approved', [App\Http\Controllers\ReviewsController::class, 'approved'])->name('reviews.approved');
