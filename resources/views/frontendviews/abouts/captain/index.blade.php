...
<div class="container mx-auto mt-10">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div class="flex flex-col items-center bg-gray-100 p-6 rounded-lg shadow-lg">
            <img src="{{ asset('assets/img/directorimg.jpeg') }}" alt="Director Patric Onyango" class="w-full h-auto rounded-lg mb-4">
            <p class="font-semibold text-xl text-center">Patric Onyango</p>
        </div>

        <!-- Director's Message Section -->
        <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
            <h2 class="text-2xl font-semibold text-center mb-6">Director's Message</h2>
